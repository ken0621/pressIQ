...
/**
 * Air21 - all tracking ship module
 *
...
class Air21
{
	 ...
	 * @param  [int] $customer_id         [current customer]
	 * @param  [int] $transaction_list_id [order id]
	 * @return [array]                    ['status', 'status_message']
	 */
	public static function sendInfo($customer_id, $transaction_list_id)
	{
		$pnm["cons_acct_num"]     = null; // Consignee/Recipient's Account Number (if there's any) char (17)
		$pnm["cons_name"]         = "Test Name"; // Consignee/Recipient's Name char (35)
		$pnm["ship_to"]           = "Air21"; // Consignee/Recipient's Company Name (if there's any) char (35)
		$pnm["ship_to_addr1"]     = "Test"; // Shipper's House/Bldg/Street Number char (35)
		$pnm["ship_to_addr2"]     = "Test"; // Shipper's Barangay/Locality char (35)
		$pnm["ship_to_addr3"]     = "Test"; // Shipper's City/Municipality char (35)
		$pnm["ship_to_addr4"]     = "Test"; // Shipper's Province char (35)
		...
		$pnm["shp_val"]           = 100; // Shipment's Declared Value numeric (10)
		...
		$reference_number["cref_num"] = "test10122017"; // Customer's own reference number char (35)
		...
		else 
		{
			...
			{
				return "Some error occurred. Please contact the administator.";
			}
		}
	}
}