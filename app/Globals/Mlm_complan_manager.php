                    ...
                    if(isset($settingss->matching_settings_earnings))
                    {
                        ...
                        if($settingss->matching_settings_gc_count != 0 && $settingss->matching_settings_gc_amount != 0)
                        {
                        	...
                        	else
                        	{
		                        ...
		                        $log = "Congratulations Your Slot " . $matching_log_earner . " Earned " . $matching_log_earning . " From Membership Matching. Slot " . $slot_aaa->slot_no . "(level ". $matching_log_level_1 .") (".name_format_from_customer_info($slot_aaa).") and Slot " . $slot_bbb->slot_no . "(level ". $matching_log_level_2 .") (".name_format_from_customer_info($slot_bbb).") Matched.";
