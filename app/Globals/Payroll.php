...
// salary_philhealth
		...
		if($data['minimum_wage'] == 1)
		{
			...
			{
				$data['tax_contribution'] = divide(Payroll::tax_contribution($shop_id, $data['salary_taxable'], $data['tax_status'], $payroll_period_category), $period_category_arr['period_count']);
