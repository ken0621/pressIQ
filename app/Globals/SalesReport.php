    ...
    public static function SalesReportBy($type, $shop_id, $start = '0000-00-00', $end = '0000-00-00')
    {
        if($type == "product")
        {
            ...
            foreach($_product as $product)
            {
                ...
                {
                    $data["item"][$product->evariant_prod_id]["quantity_sold"] = $data["item"][$product->evariant_prod_id]["quantity_sold"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("quantity");
                    $data["item"][$product->evariant_prod_id]["gross_sales"]   = $data["item"][$product->evariant_prod_id]["gross_sales"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                    $data["item"][$product->evariant_prod_id]["discount"]      = $data["item"][$product->evariant_prod_id]["discount"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.discount_amount");
                    $data["item"][$product->evariant_prod_id]["refund"]        = $data["item"][$product->evariant_prod_id]["refund"] + 0;
                    $data["item"][$product->evariant_prod_id]["net_sales"]     = $data["item"][$product->evariant_prod_id]["net_sales"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                    $data["item"][$product->evariant_prod_id]["tax"]           = $data["item"][$product->evariant_prod_id]["tax"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.tax");
                    $data["item"][$product->evariant_prod_id]["total"]         = $data["item"][$product->evariant_prod_id]["total"] + Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.total");
                }
                else
                {
                    $data["item"][$product->evariant_prod_id]["info"]          = $product;
                    $data["item"][$product->evariant_prod_id]["quantity_sold"] = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("quantity");
                    $data["item"][$product->evariant_prod_id]["category_name"] = Tbl_category::where("type_id",$product->eprod_category_id)->first()->type_name;
                    $data["item"][$product->evariant_prod_id]["gross_sales"]   = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                    $data["item"][$product->evariant_prod_id]["discount"]      = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.discount_amount");
                    $data["item"][$product->evariant_prod_id]["refund"]        = 0;
                    $data["item"][$product->evariant_prod_id]["net_sales"]     = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                    $data["item"][$product->evariant_prod_id]["tax"]           = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.tax");
                    $data["item"][$product->evariant_prod_id]["total"]         = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.total");                
                }
            }
        ...
        else if($type == "product_variant")
        {
            ...
            foreach($_product as $product)
            {
                ...
                $data["item"][$ctr]["gross_sales"]    = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                $data["item"][$ctr]["discount"]       = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.discount_amount");
                $data["item"][$ctr]["refund"]         = 0;
                $data["item"][$ctr]["net_sales"]      = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.subtotal");
                $data["item"][$ctr]["tax"]            = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.tax");
                $data["item"][$ctr]["total"]          = Tbl_ec_order_item::ecorder(['Complete'])->whereBetween(DB::raw('date(tbl_ec_order.created_date)'),$date)->where("item_id",$product->evariant_id)->sum("tbl_ec_order_item.total");                
                $ctr++;
            }
