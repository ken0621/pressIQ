...
class Seed_manual
{
    ...
    public static function transaction_reference_number($shop_id)
    {
        if(!DB::table('tbl_transaction_reference_number')->where("shop_id",$shop_id)->first())
        {
            ...
            $insert[13]['key']       = "accounting_transaction";  
            $insert[13]['prefix']    = "ACCTGTR"; 
            $insert[13]['other']     = "Y/m/d"; 
            $insert[13]['separator'] = "-"; 

            DB::table('tbl_transaction_reference_number')->insert($insert);
