...
class AgentTransactionController extends Member
{
    ...
    public function agents_transaction($agent_id)
    {
        ...
        foreach ($data["_sir"] as $key => $value) 
        {
            ...
            $data["rcv_payment"] = Tbl_manual_receive_payment::customer_receive_payment()->whereBetween("tbl_manual_receive_payment.rp_date",array($start_date,$end_date))->selectRaw("*, tbl_manual_receive_payment.rp_date as manual_rp_date")->where("sir_id",$value->sir_id)->get();
            ...
            $data["credit_memo"] = Tbl_manual_credit_memo::customer_cm()->whereBetween("tbl_manual_credit_memo.manual_cm_date",array($start_date,$end_date))->where("sir_id",$value->sir_id)->get();
        ...
        {
            return strtotime($a['date_created'] - $b['date_created']);
        });
        // dd($data['tr']);
