...
class Tbl_customer_estimate extends Model
{
    ...
    {
    	return $query->join("tbl_customer","tbl_customer.customer_id","=","tbl_customer_estimate.est_customer_id");
    }
    public static function scopeEstimate_item($query)
    {
    	return $query->join("tbl_customer_estimate_line","tbl_customer_estimate_line.estline_est_id","=","tbl_customer_estimate.est_id")
    				->join("tbl_item","tbl_item.item_id","=","estline_item_id");
    }
