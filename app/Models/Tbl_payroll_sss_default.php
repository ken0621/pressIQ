...
class Tbl_payroll_sss_default extends Model
{
    protected $table = 'tbl_payroll_sss_default';
	protected $primaryKey = "payroll_sss_default_id";
    public $timestamps = true;

    /* COLUMN NAME REFERENCE */

	// [PRIMARY KEY] 	payroll_sss_default_id
