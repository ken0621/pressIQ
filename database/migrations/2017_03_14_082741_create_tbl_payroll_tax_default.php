...
class CreateTblPayrollTaxDefault extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_payroll_tax_default', function (Blueprint $table) {
            $table->increments('payroll_tax_default_id');
    ...
    {
        Schema::drop('tbl_payroll_tax_default');
    }
}
