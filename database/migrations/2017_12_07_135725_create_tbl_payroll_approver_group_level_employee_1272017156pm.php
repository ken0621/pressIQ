...
class CreateTblPayrollApproverGroupLevelEmployee1272017156pm extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_payroll_approver_group_level_employee', function (Blueprint $table)
        {
            ...
            $table->integer("payroll_approver_group_level_id")->unsigned();
            $table->foreign("payroll_approver_group_level_id", 'pagl_id_foreign')->references('payroll_approver_group_level_id')->on('tbl_payroll_approver_group_level')->onDelete('cascade');
