...
function sales_receipt()
{
	...
	function action_load_open_transaction($customer_id)
	{
		...
		{
			$.ajax({
				url : '/member/transaction/sales_receipt/count-transaction',
				type : 'get',
				data : {customer_id : $customer_id},
				success : function(data)
				{
					$(".open-transaction").slideDown();
					$(".popup-link-open-transaction").attr('link','/member/transaction/sales_receipt/load-transaction?c='+$customer_id);
...
function success_sales_receipt(data)
{
