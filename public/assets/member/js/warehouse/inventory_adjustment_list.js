var inventory_adjusment_list = new inventory_adjusment_list();
var load_table_data = {};

function inventory_adjusment_list()
{
	init();
	...
	function action_load_table()
	{
		...
		$.ajax(
		{
			url:"/member/item/warehouse/inventory_adjustment/load-inventory-adjustment",
