...
!$("html").is(".lt-ie9") || (ltIE9 = !0), ltIE9 && (verboseBuild = !1), Modernizr.addTest("ipad", function() {
...
}), Modernizr.appleios && $("html").addClass("ios-device"), !verboseBuild || console.log("Starting builds:"), $(document).ready(function() {
    !verboseBuild || console.log("-- starting proton.common build"), proton.common.build()
}), proton.common = {
    build: function() {
        ...
        }, 50), !verboseBuild || console.log("            proton.common build DONE")
    },
    events: function() {
        !verboseBuild || console.log("            proton.common binding events"), $(document).on("touchmove", function(a) {
            a.preventDefault()
    ...
    onResizeEnd: function() {
        !verboseBuild || console.log("Window size changed"), !verboseBuild || console.log("            proton.common.onResizeEnd()"), !proton.userNav || proton.userNav.shuffleUserNav(), !proton.dashboard || proton.dashboard.setBlankWidgets(), setTimeout(function() {
    ...
    enableTooltips: function() {
        !verboseBuild || console.log("            proton.common.enableTooltips()"), $(".uses-tooltip").tooltip({
            container: "body"
    ...
    !verboseBuild || console.log("-- starting proton.mainNav build"), proton.mainNav.build()
}), proton.mainNav = {
    build: function() {
        proton.mainNav.events(), !verboseBuild || console.log("            proton.mainNav build DONE")
    },
    events: function() {
        !verboseBuild || console.log("            proton.mainNav binding events"), $(".touch nav.main-menu").on("click", function() {
            ...
            $(".touch nav.main-menu").is(".expanded") && ($(".main-menu-access").removeClass("active"), $("nav.main-menu").find(".active").removeClass("active"), $(".touch nav.main-menu").removeClass("expanded"), $("html, body").animate({
                scrollTop: 0
            }, 300, "swing")), $("nav.user-menu > section .active").removeClass("active"), $(".nav-view").fadeOut(30)
    ...
    !verboseBuild || console.log("-- starting proton.userNav build"), proton.userNav.build()
}), proton.userNav = {
    build: function() {
        proton.userNav.events(), proton.userNav.shuffleUserNav(), setTimeout(function() {
            proton.userNav.bounceCounter()
        }, 3e3), !verboseBuild || console.log("            proton.userNav build DONE")
    },
    events: function() {
        !verboseBuild || console.log("            proton.userNav binding events"), $(document).on("click", ".user-menu-wrapper a", function() {
            ...
            }), $.cookie("protonTheme", a, {
                expires: 7,
                path: "/"
            }), "default" !== a && $("body").addClass(a)
        })
    },
    shuffleUserNav: function() {
        !verboseBuild || console.log("            proton.userNav.shuffleUserNav()"), ltIE9 || Modernizr.mq("(min-width:" + screenXs + "px)") ? $("body > .user-menu").prependTo(".wrapper") : $(".wrapper .user-menu").prependTo("body")
    },
