...
function process_sale()
{
	...
	function add_to_cart()
	{
		...
		$('#submit-product').on('click', function()
		{
			...
			$.ajax(
			{
				url: 'stockist/transaction/sales/add_to_cart',
				type: 'post',
				dataType: 'json',
				data: $_form_field,			
			})
	...
	function edit_qty()
	{
		...
		$('#edit-submit-product').on('click', function(event)
		{
			...
			$.ajax(
			{
				url: 'stockist/transaction/sales/edit_cart',
				type: 'post',
				dataType: 'json',
				data: $_form_field,			
			})
	...
	function remove_to_cart()
	{
		...
		$('#product-cart').on('click', '.remove-to-cart', function(event)
		{
			...
			var $product_id = $(this).attr('product-id');
			$.ajax({
				url: 'stockist/transaction/sales/remove_to_cart',
				type: 'post',
				dataType: 'json',
	...
	{	var $slot_id = "";
		...
		$('#cart-container').load('stockist/transaction/sales/get_cart?slot_id='+$slot_id+$other+$credit);
	...
	{
		var $member_url = "stockist/transaction/sales/member"; 
		var $non_member_url = "stockist/transaction/sales/non-member";
	...
	function select_member()
	{
		...
		$('#select-member').on('change', function()
		{
			...
			$.ajax({
				url: 'stockist/transaction/sales/get_slots',
				type: 'get',
				dataType: 'json',
