			...
			<div class="fill-up-container row clearfix">
				<div class="col-md-6">
					...
					<div class="account-details">
						...
						<input type="text" name="" placeholder="Your Last Name">
						<input type="text" name="" placeholder="Company (Optional)">
						<input type="email" name="" placeholder="Email Address">
						<input type="tel" name="" placeholder="" value="+63">
						<input type="text" name="" placeholder="TIN (Optional)">
