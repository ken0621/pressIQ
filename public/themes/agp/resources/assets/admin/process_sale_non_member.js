...
function process_sale()
{
	...
	{	var $slot_id = "";
		...
		$('#cart-container').load('admin/transaction/sales/get_cart?positional_discount=1'+$other+$credit+$lead);
	...
	{
		var $member_url = "admin/transaction/nonmember_sales/process/member"; 
