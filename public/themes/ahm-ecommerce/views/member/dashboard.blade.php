		...
		<div class="row clearfix">
			<div class="col-md-6">
				<div class="square-container">
					<div class="title">Wallet Summary
						<a href="javascript:" onclick="action_load_link_to_modal('/members/enter-code')" class="title-button btn-enter-a-code"><div>Create New Slot</div></a>
					</div> 
					...
					<div class="sub-container">
						<div class="table-holder">
							<div class="chart-legend">
								<div class="holder">
									<div class="color cw"></div>
									<div class="name"><span>Current PPV</span> <div class="name cw-text">{{number_format($ppv , 2)}} POINT(S)</div></div>
								</div>
								<div class="holder">
									<div class="color tp"></div>
									<div class="name"><span>Current GPV</span> <div class="name tp-text">{{number_format($gpv , 2 )}} POINT(S)</div></div>
								</div>
								<div class="holder">
									<div class="color tp"></div>
									<div class="name"><span>Current Leadership Points</span> <div class="name tp-text">{{number_format($leadership , 2 )}} POINT(S)</div></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="square-container">
					...
					<div class="sub-container">
						<div class="chart-legend">
								<div class="holder">
									<div class="color"></div>
									<div class="name"><span>Unilevel Bonus</span> <div class="name w2hpx">PHP {{number_format($unilvl,2)}}</div></div>
								</div>
								{{-- <div class="holder">
									<div class="color"></div>
									<div class="name"><span>Total GC </span> <div class="name w2hpx">PHP {{number_format($gc,2)}}</div></div>
								</div> --}}
								<div class="holder">
									<div class="color"></div>
									<div class="name"><span>Direct Referral Bonus</span> <div class="name w2hpx">PHP {{number_format($direct,2)}}</div></div>
								</div>
								<div class="holder">
									<div class="color"></div>
									<div class="name"><span>Indirect Referral Bonus</span> <div class="name w2hpx">PHP {{number_format($indirect,2)}}</div></div>
								</div>
								<div class="holder">
									<div class="color"></div>
									<div class="name"><span>Leadership Bonus</span> <div class="name w2hpx">PHP {{number_format($stairstep,2)}}</div></div>
								</div>
								<div class="holder">
									<div class="color"></div>
									<div class="name"><span>Retail Commission</span> <div class="name w2hpx">PHP {{number_format($retail_commission,2)}}</div></div>
								</div>
						 </div>
					</div>
				</div>
					...
					<div class="sub-container">
						...
						<div class="holder">
							<div class="row clearfix">
								...
								<div class="col-sm-6 text-center">
									<div class="label2">{{ $slot->slot_no }}</div>
									<div class="label3"> <a href="javascript:" onclick="action_load_link_to_modal('/members/product-lead?slot_no={{ $slot->slot_no }}')"> VIEW PRODUCT REPLICATED LINK</a></b></div>
								</div>
							</div>
						</div>
						@endforeach
	            ...
	            <div class="modal-md modal-dialog">
	                <div class="modal-content">
	                    <div class="modal-body">
	                        ...
	                        <div class="text-header">Congratulations!</div>
	                        <div class="text-caption">You are now officially a distributor of <br><b>Heartzone</b>.</div>
	                    </div>
	                </div>
	            </div>
	        </div>
