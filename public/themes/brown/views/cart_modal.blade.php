        ...
        <div class="modal-footer row clearfix">
            <div class="col-md-8">
                <div class="left-btn-container">
                    ...
                    <button class="btn-checkout" onclick="location.href='/members/test/paymaya'">Checkout with Paymaya</button>
                    <button class="btn-checkout" onclick="location.href='/members/test/dragonpay'">Checkout with Dragonpay</button>
                </div>
            </div>
            <div class="col-md-4">
                @if(isset($cart) && $cart)
