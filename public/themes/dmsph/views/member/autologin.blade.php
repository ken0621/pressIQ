				...
				<form class="autoform" action="/members/login" method="post">
					...
					<div class="form-group">
						<div class="input-group input-group-lg">
						  ...
						  <input type="email" name="email" value="{{ request()->email }}" class="form-control" placeholder="Email / Username" aria-describedby="sizing-addon1">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group input-group-lg">
						  <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-lock" aria-hidden="true"></i></span>
						  <input type="password" name="password" value="{{ $password }}" class="form-control" placeholder="Password" aria-describedby="sizing-addon1">
						</div>
					</div>
