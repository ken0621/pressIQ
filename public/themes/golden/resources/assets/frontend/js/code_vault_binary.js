...
function code_vault()
{
	...
	function add_event_use_product_code()
	{
		$(".use-p").click(function(e)
		{
			...
			$points_comission = $(e.currentTarget).attr("points_comission");
			$points_position = $(e.currentTarget).attr("points_position");
			$points_maintenance = $(e.currentTarget).attr("points_maintenance");
			$(".product-code-id-reference").val($code_id);
			$(".unilevel_pts_container").val($unilevel_pts);
			$(".binary_pts_container").val($binary_pts);
			$(".points_comission_container").val($points_comission);
			$(".points_position_container").val($points_position);
			$(".points_maintenance_container").val($points_maintenance);
		});
	}
