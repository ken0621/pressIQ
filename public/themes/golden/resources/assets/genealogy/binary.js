...
function genealogy_loader()
{
    ...
    function load_downline($slot_id)
    {
        ...
        adjust_tree();
        $(".parent[slot_id=" + $slot_id + "]").siblings(".child-container").load('admin/maintenance/slots/binary/downline?id=' + $slot_id, function()
        {
            child_load_event();
            registration_form_event();
        });
    ...
    function registration_form_event_bind()
    {
        ...
        $(".delete-slot").bind("click", function(e)
        {
            ...
            $.ajax(
            {
                url:"admin/maintenance/slots/binary/delete",
                dataType:"json",
        ...
        $(".submit-add-save").bind("submit", function(e)
        {
            ...
            $.ajax(
            {
                url:"admin/maintenance/slots/binary/add_form_submit_message",
                dataType:"json",
                ...
                success: function(data)
                {
                    $.ajax(
                    {
                        url:"admin/maintenance/slots/binary/add_form_submit",
                        dataType:"json",
                        data: $(".submit-add-save").serialize(),
                        type:"post",
        ...
        $(".submit-update-slot").bind("submit", function(e)
        {
            ...
            $.ajax(
            {
                url:"admin/maintenance/slots/binary/edit_form_submit",
                dataType:"json",
    ...
    function registration_form_event()
    {
        ...
        $(".add-new-slot").bind("click", function(e)
        {
            ...
            $(".new-slot-form").load('admin/maintenance/slots/binary/add_form?placement=' + placement + '&position=' + position, function()
            {
                var x = $(this).attr("href");      
                var url = window.location.href.split('#')[0];
        ...
        $(".parent .name").bind("click", function(e)
        {
            ...
            $(".new-slot-form").load('admin/maintenance/slots/binary/edit_form?placement=' + placement + '&position=' + position + '&slot_id=' + slot_id, function()
            {
                var x = $(this).attr("href");      
                var url = window.location.href.split('#')[0];
                window.location.href = url+"#newslot";
