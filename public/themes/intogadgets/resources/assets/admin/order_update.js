...
function order()
{
   ...
   function cancel_status()
   {
      ...
      $(".forcancel").bind("click", function(e)
      {
         ...
         console.log(id);
         $('#order-id-cancel').val(id);
         $('#order-id-label').text('#' + id);
      ...
      $('#reason-input').on('change', function()
      {
         ...
         if($this.val() == '_others')
         {
            $this.replaceWith('<textarea name="reason" class="form-control"></textarea>');  
         }
      });
      ...
      $('#submit-cancel-order').on('click', function()
      {
         ...
         var $form = $('form#cancel-order-form').serialize();
         $('#cancel-order-loading').show();
         ...
         $.ajax(
         {
            ...
            success:function(data)
            {
               ...
               {
                  selected_row.fadeOut('slow', function()
                  {
