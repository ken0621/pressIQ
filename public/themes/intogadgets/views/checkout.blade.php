...
{
	if ( $('.payment-method-select').val() != 1 && $('.payment-method-select').val() != 2 && $('.payment-method-select').val() != 7 ) 
	{
	...
	{
		if ( $(event.currentTarget).val() != 1 && $(event.currentTarget).val() != 2 && $(event.currentTarget).val() != 7 ) 
		{
			$('.payment-upload').removeClass("hide");
		}	
		else
