    ...
    <div class="wrapper-2">
        <div class="container">
            ...
            <div class="content-container row clearfix">
                ...
                <div class="col-md-4">
                    <div class="per-image-container">
                        ...
                        <div class="content-text-container">
                            <h1 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">We Believe</h1>
                ...
                <div class="col-md-4">
                    <div class="per-image-container">
                        ...
                        <div class="content-text-container">
                            <h1 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">We Believe</h1>
                            <div class="title-line"></div>
                ...
                <div class="col-md-4">
                    <div class="per-image-container">
                        ...
                        <div class="content-text-container">
                            <h1 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">We Believe</h1>
                            <div class="title-line"></div>
            ...
            <div class="jca-title-container">
                <p class="main-title wow fadeInDown" data-wow-duration="1s" data-wow-delay=".2s"><font class="shade-green">Benefits In</font> JCA International</p>
                <p class="sub-title wow fadeInDown" data-wow-duration="1s" data-wow-delay=".4s"><font class="shade-black">BENEFITS</font> of becoming a Member of JCA Wellness International </p>
            </div>
                ...
                <div class="content-container row clearfix">    
                    <div class="col-md-8">
                        <div class="content-container row clearfix">
                            <div class="col-md-12">
                                <div class="jca-title-container">
                                    <p class="wow fadeInLeft title-company" data-wow-duration="1s" data-wow-delay=".2s">COMPANY</p>
                                    <div class="wow fadeInLeft title-mission highlighted" data-wow-duration="1s" data-wow-delay=".3s">MISSION</div>
                                    <div class="wow fadeInLeft title-vision" data-wow-duration="1s" data-wow-delay=".3s">VISION</div>
                                </div>
                            </div>
                        </div>
