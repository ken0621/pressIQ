				...
				<div class="login-form-holder d-flex flex-column align-items-center justify-content-center">
					...
					<div class="w-35 py-3">
						<form action="">
							...
							<input class="custom-textfield w-100 mt-2 p-2" type="text" placeholder="Password">
							<button class="btn-lokal-sm w-100 mt-3">LOGIN</button>
						</form>
						<div class="content-text text-center pt-2">Don't have an account? <a class="text-link-1" href="/members/register">Register Here.</a></div>
						<div class="content-text text-center py-2">Forgot Password? <a class="text-link-1" href="#">Click Here.</a></div>
