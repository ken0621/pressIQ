...
@else
	<div class="dashboard">
		<div class="row clearfix">
			<div class="col-md-6">
				<div class="title">Wallet Summary <a href="javascript:" onclick="action_load_link_to_modal('/members/enter-codes')" class="title-button pull-right btn-enter-a-code">Create New Slot</a></div>
