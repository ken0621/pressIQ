...
<a href="/partners_views?i={{$partnerResultItem->company_id}}" style="text-decoration: none;color:#333">
<div class="col-md-3 col-sm-6" style="padding: 4px;">
   <div class="partners-div clearfix" style="padding-bottom: 15px;">
      <div class="partner-header">
         <img style="object-fit: contain;" src="{{ $partnerResultItem->company_logo }}" width="100%">
      </div>
