                            ...
                            <div class="col-md-5 product">
                                <div>
                                    ...
                                    <div class="holder" style="cursor: pointer;" key="{{ $key }}" variant-id="{{ $product_variant['evariant_id'] }}">
                                        <img style="width: 100%; object-fit: cover;" id="yellow-bag-image"  class="item-image-small match-height{{ $key == 0 ? '' : 'hide' }}" key="{{ $key }}" src="{{ $image['image_path'] }}" data-zoom-image="{{ $image['image_path'] }}">
                                    </div>
                                    @endforeach
                                </div>
                                <div class="thumb">
