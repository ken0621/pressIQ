                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-5 product">
                                <div>
                                    ...
                                    <img id="yellow-bag-image" key="{{ $key }}" variant-id="{{ $product_variant['evariant_id'] }}" class="item-image-large {{ $key == 0 ? '' : 'hide' }}" key="{{ $key }}" style="cursor: pointer;width: 100% ;position: absolute;" src="{{ $image['image_path'] }}" data-zoom-image="{{ $image['image_path'] }}">
                                    @endforeach
                                </div>
                                <div class="thumb">
                                    @foreach($product_variant['image'] as $key => $image)
