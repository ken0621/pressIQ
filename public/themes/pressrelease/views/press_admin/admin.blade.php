	...
	<div class="container">
			...
			<div class="col-md-12">
				<div class="press-member">
					<ul class="nav nav-tabs">
					   ...
					   <li class="{{ Request::segment(2) == "manage_user" ? "active" : "" }}"><a href="/pressadmin/pressreleases">Press Releases</a></li>
		...
		<div id='cssmenu'>
    		<ul>
			   ...
			   <li class="{{ Request::segment(2) == "email" ? "active" : "" }}"><a href="/pressadmin/email">Email</a></li>
			   <li class="{{ Request::segment(2) == "import_recipient" ? "active" : "" }}"><a href="/pressadmin/import_recipient">Importation</a></li>
			</ul>
		</div>
		<div class="tab-content">
			@yield("pressview")
