    			...
    			<div class="col-md-12">
    				<div class="press-member">
							...
							<ul class="nav nav-tabs">
							   ...
							   <li class="{{ Request::segment(2) == "" ? "active" : "" }}"><a href="/pressuser">Press Release</a></li><!-- Add link -->
							   <li class="{{ Request::segment(2) == "view" ? "active" : "" }}"><a href="/pressuser">My Press Releases</a></li><!-- add link -->
							</ul>
