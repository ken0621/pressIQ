    				...
    				<div class="press-member">
						@if(Request::segment(2)=="view")
							<ul class="nav nav-tabs">
							   <li class="{{ Request::segment(2) == "" ? "active" : "" }}"><a href="/pressuser">Dashboard</a></li>
							   <li class="{{ Request::segment(2) == "" ? "active" : "" }}"><a href="/pressuser">Press Release</a></li>
							   <li class="{{ Request::segment(2) == "view" ? "active" : "" }}"><a href="javascript:">My Press Releases</a></li>
							</ul>
		    				   ...
		    				   <!-- My Press Release -->
	       					   <div id="my_press_releases" class="tab-pane fade">
	   					 			<div class="my-press-release-container">
	   					 				<div class="title-container"><a href="/pressuser/view">Press Release 1</a></div>
