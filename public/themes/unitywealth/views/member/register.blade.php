							...
							<div class="register-form">
								...
								<div class="form-group clearfix" style="margin-top: 15px;">
									<div class="checkbox agreement-checkbox">
									  <label><input type="checkbox" value="" required> I agree to the Unity Wealth <span>Terms of Use and Privacy Policy</span></label>
									</div>
								</div>
								<div class="form-group">
									<div class="choice">
...
<div class="modal fade modal-agreement" id="modal_agreement" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">Accept Unity Wealth Contract</div>
