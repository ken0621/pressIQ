	...
	<div class="main-member-header clearfix">
		...
		<div class="right">
			<div class="text-right">
				<button onclick="action_load_link_to_modal('/members/payout-setting', 'lg')" type="button" class="btn btn-gear btn-def-custom"><i class="fa fa-bank"></i> PAYOUT SETTINGS</button>
				<button onclick="action_load_link_to_modal('/members/request-payout','md')" type="button" class="btn btn-payout-custom"><i class="fa fa-credit-card"></i> REQUEST PAYOUT</button>
			</div>
		</div>
	</div>
