@extends("layout")
@section("content")
<div class="intro" style="background-image: url('/themes/{{ $shop_theme }}/img/weconnect_pic001.jpg')">
	<div class="container">
		<div class="text">
			<div class="title">Lorem Ipsum Dolor Sit Amet</div>
			<div class="desc">
				<div class="first-line">consectetuer adipiscing elit.</div>
				<div class="second-line">Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</div>
				<button class="btn-learn">LEARN MORE</button>
			</div>
		</div>
		<div class="login-form">
			<h4 class="form-message">Join us today</h4>
			<form method="post" action="/mlm/register" class="global-submit" autocomplete="on"> 
                ...
                <div class="form-group">
                    <input required class="form-control" type="text" name="customer_mobile" placeholder="PHONE NUMBER">
                </div>
                <div class="form-group">
...
<div>
	<div class="col-md-6">
		...
		<h4>NO QUESTIONS ASKED MONEY BACK GUARANTEE</h4>
