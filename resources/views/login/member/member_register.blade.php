...
<head>
	...
	<title>Digima House - Register</title>
			...
			<section class="panel panel-default">
				...
				<ul class="list-group">
					<li class="list-group-item">
						...
						<span class="welcome-text hide">
							Start your 60 Days trial of your ERP System
						</span>
						...
						@else
						<span class="member">
							<a href="register">Click here </a> to know more about Digima House<br>
						</span>
						@endif
					...
					<li class="list-group-item">
						...
						<div class="form-group">
							...
							<input value="{{ old('password') }}" name="password" type="password" class="form-control input-lg" id="password" placeholder="Password">
						</div>
						<div class="form-group">
							<label for="password">Confirm Password</label>
							<input value="{{ old('password_confirmation') }}" name="password_confirmation" type="password" class="form-control input-lg" id="confirm-password" placeholder=" Confirm Password">
						</div>
						<div class="form-group">
							<label for="store-name">Store Name</label>
							<input value="{{ old('store-name') }}" name="store-name" type="text" class="form-control input-lg" id="store-name" placeholder="Store Name">
						</div>
					</li>
				</ul>
				<div class="panel-footer">
					<button class="btn btn-lg btn-success" type="submit">Start Your Trial Now</button>
					<br>
					<a class="forgot" href="/login">&laquo; Back to <b>Login Page</b></a>
				</div>
			</section>
		</section>
	</form>
