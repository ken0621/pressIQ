    ...
    <div class="panel-heading">
        <div>
            ...
            <div class="dropdown pull-right">
                <button onclick="location.href=''" class="btn btn-primary"><i class="fa fa-star"></i> Create Credit Memo</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="search-filter-box">
        ...
        <div class="col-md-4" style="padding: 10px">
            <div class="input-group">
                ...
                <input type="text" class="form-control search-employee-name" placeholder="Search by transaction" aria-describedby="basic-addon1">
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-bordered table-striped table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">CM20171214-00001</td>
