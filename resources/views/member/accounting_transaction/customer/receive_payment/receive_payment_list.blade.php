    ...
    <div class="panel-heading">
        <div>
            ...
            <div class="dropdown pull-right">
                <button onclick="location.href='/member/transaction/receive_payment/create'" class="btn btn-primary"><i class="fa fa-star"></i> Receive Payment</button>
            </div>
        </div>
    </div>
</div>
...
@section('script')
<script type="text/javascript" src="/assets/member/js/accounting_transaction/customer/rp_list.js"></script>
@endsection