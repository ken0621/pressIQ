    ...
    <div class="panel-heading">
        <div>
            ...
            <div class="dropdown pull-right">
                <button onclick="location.href='/member/transaction/sales_order/create'" class="btn btn-primary"><i class="fa fa-star"></i> Create Sales Order</button>
            </div>
        </div>
    </div>
</div>
<div class="panel panel-default panel-block panel-title-block panel-gray "  style="margin-bottom: -10px;">
    <ul class="nav nav-tabs">
        <li class="active change-tab cursor-pointer accepted-tab" mode="accepted"><a class="cursor-pointer"><i class="fa fa-folder-open-o"></i> Open</a></li>
            ...
            <div class="clearfix">
                <div class="col-md-12">
                    <div class="table-responsive load-item-table">
                        <div class="text-center">LOADING TRANSACTIONS...</div>
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@section('script')
<script type="text/javascript" src="/assets/member/js/accounting_transaction/customer/so_list.js"></script>
@endsection