...
<div class="panel panel-default panel-block panel-title-block panel-gray "  style="margin-bottom: -10px;">
    <ul class="nav nav-tabs">
       <!--  <li class="active change-tab pending-tab cursor-pointer" mode="pending"><a class="cursor-pointer"><i class="fa fa-folder-open-o"></i> Open</a></li>
        ...
        <li class="cursor-pointer active change-tab approve-tab" mode="all"><a class="cursor-pointer"><i class="fa fa-list"></i> All</a></li>
    </ul>
...
@endsection
@section('script')
<script type="text/javascript" src="/assets/member/js/accounting_transaction/customer/sr_list.js"></script>
@endsection