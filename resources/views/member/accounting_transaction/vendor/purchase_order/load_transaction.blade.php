                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-condensed table-bordered">
                            ...
                            <tbody>
                                @foreach($_pr as $pr)
                                <tr>
                                    <td class="text-center"><input type="checkbox" name="_apply_transaction[{{$pr->requisition_slip_id}}]" class="td-check-pr" {{isset($_applied[$pr->requisition_slip_id]) ? 'checked' : ''}}></td>
...
<script type="text/javascript">
    ...
    {
        $('body').on('click','.td-check-pr', function()
        {
