  ...
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        ...
        <th><center>Leader Points</center></th>
      </tr>
    </thead>
    <tbody>
      @foreach($_slot as $slot)
        <tr>
          ...
          <td><center>{{number_format($slot->rank_leader,2)}}</center></td>
        </tr>
      @endforeach
    </tbody>
  </table>
...
<form type="POST" class="secured_distribute" action="/member/mlm/distribute_leader/distribute">
