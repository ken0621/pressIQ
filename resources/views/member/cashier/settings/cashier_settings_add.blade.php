<form class="global-submit form-horizontal" id="form_submit" role="form" action="/member/cashier/settings/add_submit" method="post">
            ...
            <div class="sale-module">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control text-right" placeholder="Method Name" value="" name="payment_name">
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped table-condensed">
                            ...
                            <tbody>
                                @foreach($_type as $type)
                                  <tr class="append">
                                    <td>
                                        <input type="checkbox" value="{{$type->payment_type_id}}" name="payment_type_id[]">
