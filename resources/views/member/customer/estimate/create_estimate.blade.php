    ...
    <div class="panel panel-default panel-block panel-title-block" id="top">
        <div class="panel-heading">
            <div>
                ...
                <h1>
                    <span class="page-title">Create Estimate</span>
                    <small>
               ...
               <div class="dropdown pull-right">
                <div>
                    <a class="btn btn-custom-white" href="/member/customer/estimate_list">Cancel</a>
                    ...
                    <div class="col-md-12" style="padding: 30px;">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="datepicker form-control input-sm" name="est_exp_date" value="{{$est->est_exp_date or date('m/d/y')}}" />
                            </div>
                        </div>
