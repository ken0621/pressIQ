...
<table width="100%" style="padding: 0; margin-top: 20px ">
	...
	@endif	
		...
		<tr>
			<td ></td>
			<td colspan="3" style="text-align: left;font-weight: bold">EWT ({{$invoice->ewt * 100}} %)</td>
		...
		<tr>
			<td ></td>
			<td colspan="3" style="text-align: left;font-weight: bold">Discount {{$invoice->inv_discount_type == 'percent' ? $invoice->inv_discount_type."%" : '' }}</td>
		...
		<tr>
			<td ></td>
			<td colspan="3" style="text-align: left;font-weight: bold">Vat (12%)</td>
			<td style="text-align: right; font-weight: bold">{{currency("PHP",$taxable_item * (12/100))  }}</td>
		</tr>
		@endif
		<tr class="{{$cm_total = 0}}">
			<td></td>
			<td colspan="3" style="text-align: left;font-weight: bold">INVOICE TOTAL</td>
		...
		@if($cm != null)
			...
			<tr>
				<td></td>
				<td  colspan="3" style="text-align: left;font-weight: bold">RETURNS SUBTOTAL</td>
