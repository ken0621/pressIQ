...
<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        <div>
            ...
            <h1>
                <span class="page-title">Tracking Number &raquo; Import</span>
                <small>
                </small>
            </h1>
            <a href="/member/ecommerce/import/tracking/item-template" class="btn btn-custom-white pull-right">Download Item Template</a>
            <a href="/member/ecommerce/import/tracking/item-export-error" class="btn btn-custom-white pull-right import-error hidden"></a>
        </div>
    </div>
</div>
...
<div class="panel panel-default panel-block panel-title-block clearfix">
    ...
    <div class="col-md-6">
        ...
        <div class="table-responsive" style="overflow: auto; margin-top: 7.5px;">
...
<script type="text/javascript">
    var url_link = '/member/ecommerce/import/tracking/item-read-file';
</script>
