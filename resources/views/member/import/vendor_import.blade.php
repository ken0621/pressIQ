...
<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        <div>
            ...
            <h1>
                <span class="page-title">Vendor &raquo; Import</span>
                <small>
                </small>
            </h1>
            <a href="/member/vendors/import/vendor-template" class="btn btn-custom-white pull-right">Download Vendor Template</a>
...
<div class="panel panel-default panel-block panel-title-block clearfix">
    <div class="col-md-6">
        <h4><span class="counter">0</span> Vendor Added</h4>
        <div class="progress">
        ...
        <div id="ImportContainer">
            <form action="/member/vendors/import/url" id="myDropZoneImport" class="dropzone" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    var url_link = '/member/vendors/import/vendor-read-file';
</script>
