<form class="global-submit" action="/member/item/mulitple_price_modal">
    ...
    <input type="hidden" naem="item_id" value="{{$item_id}}">
                    ...
                    @if(isset($_mulitple_price))
                        @foreach($_multiple_price as $price)
                            <tr class="tr-item-price">
                                ...
                                <td><input class="text-center form-control input-sm item-price-qty" type="text" name="item_qty[]" value="{{$price->multiprice_qty}}" /></td>
                                <td><input class="text-center form-control input-sm item-price-value" type="text" name="item_price[]" value="{{$price->multiprice_price}}" /></td>
