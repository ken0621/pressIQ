<form class="global-submit form-horizontal" role="form" action="/member/item/category/archived_submit" id="confirm_answer" method="post">
{!! csrf_field() !!}
...
<div class="modal-body add_new_package_modal_body clearfix">
    <div class="col-md-12">
        <h3>Are you sure you want to {{$action}} this Category ?</h3>
    </div>
