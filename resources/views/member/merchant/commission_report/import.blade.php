<form role="form" action="/member/merchant/commission_report/import" method="post" enctype="multipart/form-data">
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary btn-custom-primary" type="submit"><i class="fa fa-upload"></i> Import</button>
	</div>
</form>
