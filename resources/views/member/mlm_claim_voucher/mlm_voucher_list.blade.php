        ...
        <div class="panel panel-default panel-block panel-title-block" id="top">
            <div class="panel-heading">
                <div>
                    ...
                    <a href="/member/mlm/claim_voucher/claim" class="panel-buttons btn btn-primary pull-right">Claim</a>
                </div>
            </div>
        </div>
	                                    ...
	                                    @if($_voucher)
						                    @foreach ($_voucher as $voucher)  
						                        <tr class="tibolru">
						                            ...
						                            <!-- <td>{{$voucher->membership_total}}</td> -->
