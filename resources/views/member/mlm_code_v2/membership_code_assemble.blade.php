            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-md-8">
			            ...
			            <select class="form-control membership-item-kit-select">
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="basic-input" value="1" class="form-control text-right membership-item-kit-quantity" name="item_sku" placeholder="">
                    </div>
                </div>
                <div class="form-group">
...
<div class="modal-footer">
	...
	<button class="btn btn-primary btn-custom-primary assemble-code-submit" type="button"><i class="fa fa-qrcode"></i> Assemble Code</button>
</div>
