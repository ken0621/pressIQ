...
<div class="panel panel-default panel-block panel-title-block">
    <div class="form-group col-md-12" style="margin-top: 15px;">
        ...
        <button class="btn btn-def-white btn-custom-white pull-right customize-column" style="margin-right: 10px;"><i class="fa fa-gear"></i> CUSTOMIZE COLUMNS</button>
        ...
        <button class="btn btn-def-white btn-custom-white pull-right" style="margin-right: 10px;"><i class="fa fa-arrow-circle-down"></i> EXPORT SLOTS</button> 
