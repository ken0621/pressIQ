                ...
                <table class="table table-condensed">
                    <thead style="text-transform: uppercase">
                        ...
                        <tr>
                            ...
                            <th>REPURCHASE CASHBACK (PERCENTAGE)</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            @if(!empty($membership))
                                @foreach($membership as $key => $mem)
                                    <tr>
                                        ...
                                        <td>
                                            <form id='form{{$mem->membership_id}}' action='/member/mlm/plan/repurchase_cashback/edit/membership/points' method='post' class='global-submit'>
                                            {!! csrf_field() !!}
                                            <input type="hidden" name="membership_id" value="{{$mem->membership_id}}">
                                            <input type="number" name="membership_points_repurchase_cashback" class="form-control" value="{{$mem->membership_points_repurchase_cashback}}">
                                            </form>
                                            </td>
                                        <td>
