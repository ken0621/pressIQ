<form class="global-submit form-horizontal" role="form" action="/member/mlm/product_code/block_submit" id="block_code" method="post">
{!! csrf_field() !!}
<input type="hidden" name="item_code_id" value="{{$code->item_code_id}}">
...
<div class="modal-body add_new_package_modal_body clearfix">
    <div class="col-md-12">
        <center><h3>Activation Code: {{$code->item_activation_code}}</h3></center>
        </br>
