                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="margin-top: 15px;">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <textarea name="permanent_street" rows="2" class="form-control permanent-address" data-target=".shipping_street" placeholder="Street">{{isset($permanent->customer_street) ? $permanent->customer_street :''}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <input type="text" name="permanent_city" value="{{isset($permanent->customer_city) ? $permanent->customer_city :''}}" class="form-control permanent-address" data-target=".shipping_city" placeholder="City/Town">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="permanent_state" value="{{isset($permanent->customer_state) ? $permanent->customer_state :''}}" class="form-control permanent-address" data-target=".shipping_state" placeholder="State">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <input type="text" name="permanent_zipcode" value="{{isset($permanent->customer_zipcode) ? $permanent->customer_zipcode :''}}" class="form-control permanent-address" data-target=".shipping_zipcode" placeholder="Zip code">
                                            </div>
                                            <div class="col-md-6">
                                                <select class="form-control permanent-address" name="permanent_country" data-target=".shipping_country">
                                                @foreach($_country as $country)
                                                <option value="{{$country->country_id}}" {{isset($permanent->country_id) ? ($permanent->country_id == $country->country_id ? 'selected="selected"':'' ):''}}>{{$country->country_name}}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
