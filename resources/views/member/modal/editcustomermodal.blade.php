              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="password" class="form-control mlm_password" value="@if($customer_info->password != null){{$customer_info->password}}@endif" name="mlm_password" @if($customer_info->ismlm == 0) readonly @endif>
                  </div>
                </div>
              </div>
            </div>
