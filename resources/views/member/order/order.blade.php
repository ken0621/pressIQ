    ...
    <div class="panel-heading">
        <div>
            ...
            <h1>
                ...
                <small>
                View orders in your website
                </small>
            </h1>
            <a href="/member/ecommerce/order/new_order" class="panel-buttons btn btn-primary pull-right">Create Order</a>
...
<div class="panel panel-default panel-block panel-title-block panel-gray ">
	...
	<ul class="nav nav-tabs">
	  <li class="active cursor-pointer"><a class="cursor-pointer" data-toggle="tab" onClick="filter_function('ready', '0','0')">All Orders</a></li>
	  <li ><a class="cursor-pointer" data-toggle="tab"  onClick="filter_function('ready', '0','Unfulfilled')">Unfulfilled</a></li>
	  <li ><a class="cursor-pointer" data-toggle="tab"  onClick="filter_function('ready', 'Unpaid','0')">Unpaid</a></li>
	  <li ><a class="cursor-pointer" data-toggle="tab"  onClick="filter_function('ready', 'Refunded','0')">Refunded</a></li>
	  <li ><a class="cursor-pointer" data-toggle="tab"  onClick="filter_function('ready', 'Partially refunded','0')">Partially Refunded</a></li> 
	</ul>
	<div class="tab-content">
	  <div id="all-orders" class="tab-pane fade in active">
	    ...
	    <div class="table-responsive" id="orders-data-get">{!! $_orders !!}</div>
