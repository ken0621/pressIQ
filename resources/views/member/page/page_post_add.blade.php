...
<div class="modal-header">
    ...
    <h4 class="modal-title layout-modallarge-title item_title">Add New Post</h4>
</div>
<div class="modal-body modallarge-body-layout background-white">
	<form class="global-submit" role="form" action="/member/page/post/addsubmit" method="post">
	    <input type="hidden" name="_token" value="{{ csrf_token() }}">
	   	<input type="hidden" name="post_image">
	        ...
	        <div class="form-group">
	        	...
	        	<textarea class="form-control mce" name="post_content"></textarea>
	        </div>
	        <div class="form-group">
	        	<div class="row clearfix">
	        		<div class="col-md-6">
	        			<label style="opacity: 0">Excerpt</label>
	        			<img class="match-height img-responsive image-put image-gallery image-gallery-single" key="1" src="/assets/front/img/default.jpg" style="width: 100%; border: 1px solid #ddd;">
	        		</div>
	        		<div class="col-md-6">
		        		<label>Excerpt</label>
		        		<textarea class="form-control match-height" name="post_excerpt"></textarea>
		        	</div>
	        	</div>
	        </div>
	        <div class="form-group">
	        		...
	        		<div class="col-md-6">
	        			...
	        			<div class="category-check">
	        				<div class="check-container">
		        				...
		        				<div class="holder">
		        					<input type="checkbox" name="post_category_id[]" value="{{ $category->post_category_id }}">
