                	...
                	@foreach($_timesheet as $timesheet)
	            		...
	            		<tr class="time-record {{ $key == 0 ? 'main' : '' }}" date="{{ $timesheet->date }}" total_hours="00:00" total_normal_hours="00:00" total_early_overtime="00:00" total_late_overtime="00:00">
	                		@if($key == 0) <!--MAIN -->
								...
								<td class="text-center edit-data"><input class="text-table ot-approved time-entry-24"  type="text" name="" value="00:00"></td>
		                		<td class="text-center edit-data"><input disabled="disabled" class="text-table break-time time-entry-24"  type="text" name="" value="{{ $timesheet->break }}"></td>
