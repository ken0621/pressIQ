        ...
        <!-- TABLE TIME IN AND OUT -->
            ...
            <table class="table table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input name="time_in[{{ $time_record->payroll_time_sheet_record_id }}]" placeholder="NO TIME" class="over-time-entry form-control" time_max="{{ $time_record->time_in_max }}" time_min="{{ $time_record->time_in_min }}" {{ $time_record->time_in_enabled==true ? ''  : 'disabled' }}  type="text" value="{{ $time_record->time_in }}"></td>
                        <td><input name="time_out[{{ $time_record->payroll_time_sheet_record_id }}]" placeholder="NO TIME" class="over-time-entry form-control" time_max="{{ $time_record->time_out_max }}" time_min="{{ $time_record->time_out_min }}" {{ $time_record->time_out_enabled==true ? ''  : 'disabled' }}  type="text"  value="{{ $time_record->time_out }}"></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="60px" s="p1" class="text-center old_regular_hours">00:00</td>
                    <td width="60px" s="p1" class="text-center new_regular_hours">00:00</td>
