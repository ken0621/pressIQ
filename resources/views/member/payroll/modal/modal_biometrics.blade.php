...
<div class="modal-body clearfix form-horizontal">
	...
	<div class="form-group">
		<div class="col-md-12">
			<label class="btn btm-custom-green"><input type="file" name="" id="bio-file" class="hide" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">Choose File</label>
		</div>
		<div class="col-md-12">
