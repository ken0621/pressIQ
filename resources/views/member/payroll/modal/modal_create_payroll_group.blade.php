				    ...
				    <div class="form-group">
				    	<div class="col-md-8">
				    		...
				    		<div class="panel panel-default">
				    			<div class="panel-body form-horizontal">
				    				<div class="form-group">
				    					<label class="col-md-12">PhilHealth</label>
				    				</div>
				    				<div class="form-group">
				    					<div class="col-md-3">
				    						<div class="radio">
				    		...
				    		<div class="panel panel-default">
				    			<div class="panel-body form-horizontal">
				    				<div class="form-group">
				    					<label class="col-md-12">PAGIBIG</label>
				    				</div>
				    				<div class="form-group">
				    					<div class="col-md-3">
				    						<div class="radio">
				    		...
				    		<div class="col-md-8 form-horizontal">
				    			...
				    			<div class="form-group">
				    				<div class="col-md-6">
				    					...
				    					<input type="number" name="payroll_group_working_day_month" class="form-control">
				    				</div>
				    				<div class="col-md-6">
				    		...
				    		<div class="col-md-4">
				    			<table class="table table-bordered table-condensed padding-tb-2">
				    				...
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Sunday">Sunday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    				...
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Monday">Monday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Monday">Monday</label>
				    						</div>
				    					</td>
				    				</tr>
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Tuesday">Tuesday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Tuesday">Tuesday</label>
				    						</div>
				    					</td>
				    				</tr>
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Wednesday">Wednesday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Wednesday">Wednesday</label>
				    						</div>
				    					</td>
				    				</tr>
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Thursday">Thursday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Thursday">Thursday</label>
				    						</div>
				    					</td>
				    				</tr>
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Friday">Friday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Friday">Friday</label>
				    						</div>
				    					</td>
				    				</tr>
				    				<tr>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="restday-check" name="restday[]" value="Saturday">Saturday</label>
				    						</div>
				    					</td>
				    					<td>
				    						<div class="checkbox">
				    							<label><input type="checkbox" class="extraday-check" name="extraday[]" value="Saturday">Saturday</label>
				    						</div>
				    					</td>
				    				</tr>
				    			</table>
