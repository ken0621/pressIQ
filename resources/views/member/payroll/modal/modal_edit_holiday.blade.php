<form class="global-submit" role="form" action="/member/payroll/holiday/modal_update_holiday" method="POST">
		...
		<div class="form-group">
			<div class="col-md-12">
				...
				<ul class="list-group">
				  ...
				  <li class="list-group-item padding-3-10">
				  	<div class="checkbox">
				  		<label><input type="checkbox" name="company[]" class="company-check" value="{{$company['payroll_company_id']}}" {{$company['status']}}>{{$company['payroll_company_name']}}</label>
				  	</div>
				  </li>
				  @endforeach
				</ul>
