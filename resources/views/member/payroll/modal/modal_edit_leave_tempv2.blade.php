					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<a href="#" class="popup" size="sm" link="/member/payroll/leave/v2/modal_archived_leave_employeev2/0/{{$archived->payroll_leave_employee_id}}"><i class="fa fa-refresh"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
