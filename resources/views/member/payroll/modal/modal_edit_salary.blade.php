	...
	<div class="modal-body form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				...
				<div class="checkbox">
					<label><input type="checkbox" name="tbl_payroll_employee_custom_compute" class="custom-compute-pop-chck" value="1" {{$salary->tbl_payroll_employee_custom_compute == 1 ? 'checked':''}}>Custom Computation</label>
				</div>
			</div>
		</div>
		<div class="form-group">
