...
<form class="global-submit form-horizontal" role="form" action="{link_submit_here}" method="post">
    ...
    <div class="modal-header">
		...
		<h4 class="modal-title">Pay Leave Records </h4>
	</div>
            <input type="hidden" id="category" value="monthly_with">
    ...
    <div class="modal-footer">
        ...
        &nbsp;<a href="/member/payroll/leave/v2/pay_leave_report_excel/{{date("Y-m-d")}}/{{date("Y-m-d")}}/0"><button type="button" class="btn btn-success pull-right"><i class="fa fa-file-excel-o" ></i> &nbsp;EXPORT TO EXCEL</button></a>
    </div>
    </div>
</form>
