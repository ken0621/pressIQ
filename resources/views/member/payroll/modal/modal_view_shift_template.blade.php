						...
						@foreach($_day as $key => $day)
							<tr class="editable main-con main-time" day="{{$day->shift_day}}">
								...
								<td class="text-center">
									<input type="checkbox" name="rest_day_{{$day->shift_day}}" class="restday-check" value="1">
								</td>
								<td class="text-center">
									<input type="checkbox" name="extra_day_{{$day->shift_day}}" class="extraday-check" value="1">
								</td>
							</tr>
							@if($day->time_shift)
