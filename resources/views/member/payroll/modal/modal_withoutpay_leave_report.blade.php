...
<form class="global-submit form-horizontal" role="form" action="{link_submit_here}" method="post">
    ...
    <div class="modal-footer">
        ...
        &nbsp;<a href="/member/payroll/leave/v2/withoutpay_leave_report_excel/{{date("Y-m-d")}}/{{date("Y-m-d")}}/0"><button type="button" class="btn btn-success pull-right"><i class="fa fa-file-excel-o" ></i> &nbsp;EXPORT TO EXCEL</button></a>
    </div>
    </div>
</form>
