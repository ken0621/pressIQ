<form class="global-submit" role="form" action="/member/payroll/holiday/modal_save_holiday/v2" method="POST">
			...
			<div class="col-md-12">
				...
				<ul class="list-group">
				  ...
				  <li class="list-group-item padding-3-10">
				  	<div class="checkbox">
				  		<label >
				  			<input type="checkbox" name="company[]" class="company-check check-{{$company->payroll_company_id}}" value="{{$company->payroll_company_id}}">
			  			</label>
			  			<label>
				  			<a style="color: #000" class="popup" size="md" link="/member/payroll/holiday/modal_tag_employee/{{$company->payroll_company_id}}">{{$company->payroll_company_name}} 
			  				</a>
			  			</label>
				  	</div>
				  </li>
