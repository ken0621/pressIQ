...
<div class="main-container">
	...
	<table cellpadding="5" cellspacing="0" class="border padding-5" width="50%" height="{{ $table_height }}">
	<?php $counter=1; $td_counter=1  ?>
	...
	@foreach($_record as $brk)
			...
			<td valign="top" >
				...
				<table cellpadding="5" cellspacing="0" class="border padding-5" width="50%" height="{{ $table_height/2 }}">
