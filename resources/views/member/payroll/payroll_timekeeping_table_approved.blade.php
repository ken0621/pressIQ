                ...
                <td class="text-center">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-custom">
                        ...
                        <li><a href="javascript:" class="popup" link="/member/payroll/process_payroll/modal_approved_summary/{{ $period->payroll_period_company_id }}" size="lg">Payroll Summary</a> </li>
                        <li><a href="/member/payroll/payroll_approved_view/generate_payslip_v2/{{ $period->payroll_period_company_id }}" target="_blank">Payslip</a></li>
                        <li><a href="javascript: action_load_link_to_modal('/member/payroll/banking/{{ $period->payroll_period_company_id }}', 'lg')">Export Banking</a></li>
                      </ul>
                    </div>
                </td>
    		</tr>
