			   	...
			   	<tbody>
			   		...
			   		<tr>
			   			...
			   			<td class="text-center">  
			   				<label><a href="javascript: action_load_link_to_modal('/member/payroll/deduction/v2/modal_view_deduction_employee?deduction_category={{str_replace(' ', '_', $deduction->payroll_deduction_type)}}','lg')"> VIEW EMPLOYEE</a></label>     
			   			</td>
			   		</tr>
			   		@endforeach
