<div class="form-horizontal">
	<div class="form-group">
		<div class="col-md-12">
			<h4>Shift Template<button class="btn btn-custom-primary pull-right popup" link="/member/payroll/shift_template/modal_create_shift_template" size="lg">Create Template</button></h4>
		</div>
	</div>
