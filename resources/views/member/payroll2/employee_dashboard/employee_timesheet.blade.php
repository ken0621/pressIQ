<div class="modal-header">
    ...
    <h4 class="modal-title"><b>{{ucfirst($period->payroll_period_title_name." ".$period->payroll_period_first_name." ".$period->payroll_period_middle_name." ".$period->payroll_period_last_name." ".$period->payroll_period_suffix_name)}} - TIMESHEET</b></h4>
</div>
