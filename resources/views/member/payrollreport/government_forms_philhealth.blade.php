<form class="global-submit form-horizontal" role="form" action="{link_submit_here}" method="post">
        ...
        <div class="panel-body form-horizontal">
            <div class="form-group">
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                <select class="form-control filter-by-branch-philhealth" name="branch_location_id">
    ...
    <div class="modal-footer">
        ...
        &nbsp;<a href="/member/payroll/reports/government_forms_philhealth_export_excel/{{$month}}/0/{{ $year }}/0"><button type="button" class="btn btn-success pull-right"><i class="fa fa-file-excel-o" ></i> &nbsp;EXPORT TO EXCEL</button></a>
    </div>
    </div>
</form>
