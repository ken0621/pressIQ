<div class="modal-body clearfix">
    ...
    <div class="modal-footer">
        ...
        &nbsp;<a href="/member/payroll/reports/government_forms_sss_export_excel/{{$month}}/{{$company_id1}}/{{$year}}/{{$branch_id}}"><button type="button" class="btn btn-success pull-right"><i class="fa fa-file-excel-o" ></i> &nbsp;EXPORT TO EXCEL</button></a>
    </div>