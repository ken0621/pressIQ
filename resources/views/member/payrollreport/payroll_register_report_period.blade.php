			...
			<div id="all" class="tab-pane fade in active">
				...
				<div class="labas_mo_dito table-responsive " id="show_me_something">
					<div>
						...
						<button style="margin-right:  20px;" type="button" onclick="action_load_link_to_modal('/member/payroll/reports/modal_filter_register_columns', 'sm')" class="btn btn-def-white btn-custom-white pull-right"><i class="fa fa-cog" aria-hidden="true"></i> &nbsp;COLUMNS</button>
					</div>
