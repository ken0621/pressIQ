...
{{--                   <th valign="center" rowspan="2" class="text-center head" id="monthlybasic" style="width: 200px">MONTHLY BASIC</th>
                  ...
                  <th valign="center" colspan="2" class="text-center head" id="undertime" style="width: 150px">UNDERTIME</th>
                  <th valign="center" rowspan="2" class="text-center head" id="basic_pay" style="width: 120px">BASIC PAY</th>
                  <th valign="center" rowspan="2" class="text-center head" id="rendered_days" style="width: 120px">RENDERED DAYS</th>
                  <th valign="center" rowspan="2" class="text-center head" id="cola" style="width: 120px">COLA</th>
                  <th valign="center" colspan="2" class="text-center head" id="overtime_pay" style="width: 150px">OVER TIME PAY</th>
                  <th valign="center" colspan="2" class="text-center head" id="night_differential_pay" style="width: 150px">NIGHT DIFFERENTIAL PAY</th>
                  ...
                  <th valign="center" colspan="2" class="text-center head" id="leave_pay" style="width: 150px">LEAVE PAY</th>
                  <th colspan="8" class="text-center" id="allowancescol" style="width: 850px">ALLOWANCES</th>
                  <th valign="center" rowspan="2" class="text-center head" id="gross_pay" style="width: 100px">GROSS PAY</th>
                  <th colspan="4" class="text-center" id="deductionscol" style="width: 500px">DEDUCTIONS</th>
                  <th colspan="2" class="text-center" id="ssscol" style="width: 300px">SSS</th>
                  <th colspan="2" class="text-center" id="hdmfcol" style="width: 200px">HDMF</th>
                  ...
                  <th colspan="4" class="text-center" id="government_es" style="width: 500px">GOVERNMENT EMPLOYER SHARE</th>
            </tr>
                  
            <tr>
                  <th class="text-center head" id="absent_no" style="width: 100px">No. of Days</th>
                  <th class="text-center head" id="absent_amount" style="width: 100px">Amount</th>
                  <th class="text-center head" id="late_no" style="width: 100px">No. of Hrs.</th>
                  <th class="text-center head" id="late_amount" style="width: 100px">Amount</th>
                  <th class="text-center head" id="undertime_no" style="width: 100px">No. of Hrs.</th>
                  <th class="text-center head" id="undertime_amount" style="width: 100px">Amount</th>
                  <th class="text-center head" id="overtime_pay_no" style="width: 100px">No. of Hrs.</th>
                  <th class="text-center head" id="overtime_pay_amount" style="width: 100px">Amount</th>
                  <th class="text-center head" id="night_differential_pay_no" style="width: 100px">No. of Hrs.</th>
                  <th class="text-center head" id="night_differential_pay_amount" style="width: 100px">Amount</th>
                  <th class="text-center head" id="leave_pay_no" style="width: 100px">No. of Hrs.</th>
                  <th class="text-center head" id="leave_pay_amount" style="width: 100px">Amount</th>
...
{{--             <td class="text-center semimonthlybasic_td_td" id="semimonthlybasic_td">{{ ($employee->payroll_employee_salary_monthly / 2) }}</td> --}}
            ...
            <td class="text-center late_td_no" id="late_td">{{$employee->time_late}}</td>
            <td class="text-center late_td_td" id="late_td">{{ $employee->late }}</td>
...
$( document ).ready(function() {
        $(".head").each(function() {
            ...
            var columnvalue = $('.' + column).val();
              ...
              var government = ["sss_er", "sss_ec", "hdmf_er", "phic_er"];
              var allowances = ["allowance", "bonus", "commision", "incentives", "additions", "month_13_and_other", "de_minimis_benefit", "others"];
              var deductions = ["deductions", "cash_bond", "cash_advance", "other_loan"];
              var sss = ["sss_loan", "sss_ee"];
              var hdmf = ["hdmf_loan", "hdmf_ee"];

            if(columnvalue == 0)
            {
                  if(government.indexOf(column) != -1)
                  {
                        var span = $("#government_es").prop("colspan");
                        var newspan = span - 1;
                        $('#government_es').attr('colspan',newspan);
                  }
                  if(allowances.indexOf(column) != -1)
                  {
                        var span = $("#allowancescol").prop("colspan");
                        var newspan = span - 1;
                        $('#allowancescol').attr('colspan',newspan);
                  }
                  if(deductions.indexOf(column) != -1)
                  {
                        var span = $("#deductionscol").prop("colspan");
                        var newspan = span - 1;
                        $('#deductionscol').attr('colspan',newspan);
                  }
                  if(sss.indexOf(column) != -1)
                  {
                        var span = $("#ssscol").prop("colspan");
                        var newspan = span - 1;
                        $('#ssscol').attr('colspan',newspan);
                  }
                  if(hdmf.indexOf(column) != -1)
                  {
                        var span = $("#hdmfcol").prop("colspan");
                        var newspan = span - 1;
                  ...
                  $("." + column + "_td_no").css("display", "none");
                  $("#" + column + "_total").css("display", "none");
                  $("#" + column + "_total_total").css("display", "none");
                  $("#" + column + "col").css("display", "none");
                  $("#" + column + "_no").css("display", "none");
                  $("#" + column + "_amount").css("display", "none");
