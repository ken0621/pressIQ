...
@section('content')
<form action="/member/product/collection/update" method="POST">
...
<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        <div>
            ...
            <h1>
                <span class="page-title"><span class="color-gray">Products/Collections</span>/{{$collection->collection_name}}</span>
                <small>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-custom-primary btn-update-collection" type="button" disabled type="button">Add to order</button>
      </div>
    </div>
