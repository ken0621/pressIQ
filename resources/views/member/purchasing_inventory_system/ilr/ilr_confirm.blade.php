<form class="global-submit-page form-horizontal" role="form" action="/member/pis/ilr/ilr_submit" id="confirm_answer" method="post">
{!! csrf_field() !!}
...
<div class="modal-body add_new_package_modal_body clearfix">
    <div class="col-md-12">
        ...
        <h4>Once this SIR is saved you will no longer to edit or update this SIR</h4>
    </div>
