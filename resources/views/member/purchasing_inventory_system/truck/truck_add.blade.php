...
<form class="global-submit form-to-submit-add" action="/member/pis/truck_list/add_submit" method="post">
<style type="text/css">
    .chosen-container
    {
        width: 100% !important;
...
<div class="modal-header">
    ...
    <h4 class="modal-title layout-modallarge-title item_title">Add Truck</h4>
</div>
    ...
    <div class="panel-body form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-12">            
                ...
                <select class="form-control warehouse-truck" name="truck_warehouse">
...
<script type="text/javascript">
    $(".warehouse-truck").globalDropList(
    { 
      hasPopup                : "false",
      width                   : "100%",
      placeholder             : "Search....",
