<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        ...
        <div>
            ...
            <div class="col-md-2 hidden"><input type="text" class="form-control from_report_a datepicker" name="from" placeholder="Start Date"></div>
            <div class="col-md-2 hidden"><input type="text" class="form-control form_report_b datepicker" name="to" placeholder="End Date hidden"></div>
            <div class="col-md-3 hidden"><button class="btn btn-primary run-report" onclick="$('.report_type_i').val('plain')" >Run Report</button></div>
