...
<div class="panel panel-default panel-block panel-title-block" id="top">
    <div class="panel-heading">
        <div>
            ...
            <h1>
                <span class="page-title"> Inventory - Detailed</span>
            </h1>
        </div>
    </div>
</div>
...
@include('member.reports.output.inventory_detailed')
...
<script type="text/javascript">
    ...
    function event_run_report_click()
    {
        $(document).on("click", ".run-report", function()
        {
            ...
            $(".load-data").load("/member/report/inventory/detailed?"+serialize_data+"&load_view=true .load-content", function()
                {
                    action_collaptible(true);
                });
        });
