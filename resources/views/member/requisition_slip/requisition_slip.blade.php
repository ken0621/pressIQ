...
<div class="panel panel-default panel-block panel-title-block panel-gray "  style="margin-bottom: -10px;">
    <ul class="nav nav-tabs">
        ...
        <li id="archived-list"><a data-toggle="tab" onClick="change_status('closed');"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Closed Slip</a></li>
    </ul>
    <div class="tab-content codes_container" style="min-height: 300px;">
        <div id="all" class="tab-pane fade in active">
            ...
            <div class="clearfix">
                <div class="col-md-12">
                    @include('member.requisition_slip.requisition_slip_table')
                </div>
            </div>
        </div>
    </div>
...
@section('script')
<script type="text/javascript" src="/assets/member/js/requisition_slip.js"></script>
@endsection
