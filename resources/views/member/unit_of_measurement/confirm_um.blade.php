<form class="global-submit form-horizontal" role="form" action="/member/item/unit_of_measurement/archived_submit" id="confirm_answer" method="post">
{!! csrf_field() !!}
...
<div class="modal-body add_new_package_modal_body clearfix">
    <div class="col-md-12">
        <h3>Are you sure you want to {{$action}} this Unit of Measurement ?</h3>
    </div>
    <div class="col-md-12 text-center">
        <h4>{{$um_info->um_name}}</h4>
    </div>
