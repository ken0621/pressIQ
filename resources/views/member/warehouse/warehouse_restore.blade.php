<form class="global-submit form-horizontal" role="form" action="/member/item/warehouse/restore_submit" id="restore_warehouse" method="post">
{!! csrf_field() !!}
<input type="hidden" name="warehouse_id" value="{{$warehouse->warehouse_id}}">
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal">&times;</button>
	<h4 class="modal-title">Restore Warehouse</h4>
</div>
...
<script type="text/javascript">
 function confirm_restore_warehouse() 
 {
     // body...
     $('#restore_warehouse').submit();
 }   
</script>