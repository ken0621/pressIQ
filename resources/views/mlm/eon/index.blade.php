                    ...
                    <tbody>
                        @foreach($all_slots_p as $key => $value)
                            <tr>
                                ...
                                <td><input type="tel" id="txt_cardNumber" pattern="[0-9.]+" onkeypress="return checkDigit(event, $(this))"class="form-control slot_eon_account_no_{{$value->slot_id}}" name="slot_eon_account_no" value="{{$value->slot_eon_account_no}}"></td>
                                <td><input type="tel" id="txt_cardNumber" pattern="[0-9.]+" onkeypress="return checkDigit(event, $(this))" class="form-control slot_eon_card_no_{{$value->slot_id}}" name="slot_eon_card_no" value="{{$value->slot_eon_card_no}}"></td>
                                <td>
