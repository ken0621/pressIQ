{{--
    this is used to output sessions just use @include('sessionPrinter') at your blade //l
--}}
...
<script>
    var mode = "CONSOLE"; // Option: "CONSOLE" for outputting in the console; "HIDDEN" for accessing it via var session
