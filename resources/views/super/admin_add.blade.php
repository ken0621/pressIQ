...
<div class="pages">
   <div data-page="admin-edit" class="page">
      <div class="page-content">
         <form action="/super/admin/add" method="post" class="ajax-submit">
            {{ csrf_field() }}
                     ...
                     <div class="item-content">
                        <div class="item-inner">
                           ...
                           <div class="item-input">
                              <input value="" name="first_name" type="text" placeholder="First name">
                           </div>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="item-content">
                        <div class="item-inner">
                           ...
                           <div class="item-input">
                              <input value="" name="last_name" type="text" placeholder="Last name">
                           </div>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="item-content">
                        <div class="item-inner">
                           ...
                           <div class="item-input">
                              <input value="" autocomplete="off" name="username" type="text" placeholder="Username">
                           </div>
                        </div>
                     </div>
                  </li>
                  ...
                  <li>
                     <div class="item-content">
                        <div class="item-inner">
                           ...
                           <div class="item-input">
                              <input value="" autocomplete="off" name="password" type="text" placeholder="Password">
                           </div>
                        </div>
                     </div>
                  </li>
                        ...
                        <div class="item-inner">
                           ...
                           <div class="item-input">
                              <label class="label-switch">
                                 <input name="full_access" type="checkbox">
