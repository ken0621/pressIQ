        ...
        <div id="invoice" class="tab-pane fade in active">
            <div class="form-group">
                <div class="col-md-4 col-xs-6">
                    <a class="btn btn-primary form-control" href="/tablet/sales_receipt?sir_id={{Session::get('selected_sir')}}">Create Sales Receipt</a>
                </div>
                                ...
                                <div class="btn-group">
                                  <button type="button" class="btn btn-sm btn-custom-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Action <span class="caret"></span>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-custom">
                                        ...
                                        @endif
                                        <li><a href="/tablet/create_invoices/add?id={{$inv->inv_id}}&sir_id={{Session::get('selected_sir')}}">Edit Sales Receipt</a></li>                                        
                                    </ul>
                                </div>
                            </td>
                          </tr>
