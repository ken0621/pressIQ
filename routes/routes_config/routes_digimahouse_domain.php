...
if(($domain != "digimahouse.com" && $domain != "digimahouse.dev" && $domain != "digimatest.com") || (hasSubdomain() && $domain != "my168shop-primia.c9users.io"))
{
	...
	Route::any('/contact_us/send', 'Shop\ShopMemberController@send_contact_us_paptsi');
	Route::any('/contact_us/send', 'Shop\ShopMemberController@send_contact_us_tfwellness');
	Route::any('/contact_us/send', 'Shop\ShopMemberController@send_contact_us_livingwater');
