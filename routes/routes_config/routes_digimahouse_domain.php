...
if(($domain != "digimahouse.com" && $domain != "digimahouse.dev" && $domain != "digimatest.com") || (hasSubdomain() && $domain != "my168shop-primia.c9users.io"))
{
	...
	Route::any('/pressuser/pressrelease/delete_draft_release',		'Shop\ShopMemberController@delete_draft_release');
	...
	Route::any('/pressuser/manage_user',							'Shop\ShopMemberController@press_user_manage_user');
	Route::any('/pressuser/manage_user/profile_update',				'Shop\ShopMemberController@press_user_profile_update');  
	Route::any('/pressuser/manage_user/update/{id}',				'Shop\ShopMemberController@press_user_manage_user_update');
	Route::any('/get_admin_account',	 							'Shop\ShopMemberController@get_admin_account');
	...
	Route::any('/pressadmin/manage_user/delete_admin_user', 		'Shop\ShopMemberController@manage_user_delete_admin_user'); //PRESS RELEASE
	...
	Route::any('/pressadmin/delete_user_account',					'Shop\ShopMemberController@delete_user_account');      
	...
	Route::any('/pressadmin/pressreleases_deleterecipient/media', 	'Shop\ShopMemberController@pressreleases_deleterecipient_media');//PRESS RELEASE
	...
	Route::any('/pressadmin/delete_industry_contact', 				'Shop\ShopMemberController@delete_industry_contact'); //PRESS RELEASE
	...
	Route::any('/pressadmin/delete_media_type_contact',				'Shop\ShopMemberController@delete_media_type_contact'); //PRESS RELEASE
	...
	Route::any('/export/error/{ref}',                               'Shop\ShopMemberController@export_error');
