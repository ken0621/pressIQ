...
Route::any('/payment/paymaya/webhook/success', 'Shop\ShopCheckoutController@paymaya_success');
Route::any('/payment/paymaya/webhook/failure', 'Shop\ShopCheckoutController@paymaya_failure');
Route::any('/payment/paymaya/webhook/cancel', 'Shop\ShopCheckoutController@paymaya_cancel');
/* End Paymaya */