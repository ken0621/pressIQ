...
Route::group(array('prefix' => '/member/payroll'), function()
{
	...
	Route::any('/reports/table_loan_summary/{deduction_type}/{company}/{branch}','Member\PayrollReportController@table_loan_summary');
	...
	Route::any('/reports/loan_summary/loan_summary_report_excel/{company_id}/{deduction_type}/{branch}','Member\PayrollReportController@loan_summary_report_excel');

	/*END loan summary report*/

	/*START payroll ledger*/
	Route::any('/reports/payroll_ledger','Member\PayrollLedger@index');
	Route::any('/reports/payroll_ledger/{employee_id}/{month}','Member\PayrollLedger@modal_ledger');
	Route::any('/reports/payroll_ledger/export_excel_ledger/{employee_id}/{month}','Member\PayrollLedger@export_excel_ledger');
	Route::any('/reports/payroll_ledger_filter','Member\PayrollLedger@payroll_ledger_filter');
	Route::any('/reports/payroll_ledger/export_excel_ledgerv2/{company}/{month}/{branch}','Member\PayrollLedger@export_excel_ledgerv2');
	...
	Route::any('/reports/payroll_register_report_period/export_excel/{period_company_id}/{payroll_department_id}/{branch_id}','Member\PayrollReportController@payroll_register_report_export_excel');
	...
	Route::any('/leave/v2/view_used_leave_v2/{payroll_leave_employee_id}',"Member\PayrollController@view_used_leave_v2");
	Route::any('/leave/v2/delete_schedule_v2',"Member\PayrollController@delete_schedule_v2");
	//end schedule
	//reporting leave
