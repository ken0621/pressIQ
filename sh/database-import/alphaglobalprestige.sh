...
## LOGIN SSH ##
sshpass -p "digima2018" ssh -o StrictHostKeyChecking=no digima@159.89.201.203 "~/export.sh"
...
wget -P ~/ http://alpha-globalprestige.com/digimahouse_latest_backup.sql.gz
