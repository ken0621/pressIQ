...
## LOGIN SSH ##
sshpass -p "digima2018" ssh -o StrictHostKeyChecking=no digima@128.199.137.178 "~/export.sh"
...
wget -P ~/ http://inventory.digimahouse.com/digimahouse_latest_backup.sql.gz
