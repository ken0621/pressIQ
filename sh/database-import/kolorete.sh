...
## LOGIN SSH ##
sshpass -p "digima2018" ssh -o StrictHostKeyChecking=no digima@159.65.143.64 "~/export.sh"
...
wget -P ~/ http://koloretemktg.digimahouse.com/digimahouse_latest_backup.sql.gz
