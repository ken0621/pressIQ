...
## LOGIN SSH ##
sshpass -p "digima2018" ssh -o StrictHostKeyChecking=no digima@159.89.195.162 "~/export.sh"
...
wget -P ~/ http://unity-wealth.com/digimahouse_latest_backup.sql.gz
