...
plink -pw "digima2018" digima@159.65.143.64 "~/export.sh"

## DATABASE ##
mysql -u$username -e "DROP DATABASE $database"
mysql -u$username -e "CREATE DATABASE $database"

curl --insecure "http://koloretemktg.digimahouse.com/digimahouse_latest_backup.sql.gz" -o database/digimahouse_latest_backup.sql.gz
