...
plink -pw "digima2018" digima@159.89.197.243 "~/export.sh"

## DATABASE ##
mysql -u$username -e "DROP DATABASE $database"
mysql -u$username -e "CREATE DATABASE $database"

curl --insecure "http://sovereign-world.net/digimahouse_latest_backup.sql.gz" -o database/digimahouse_latest_backup.sql.gz
