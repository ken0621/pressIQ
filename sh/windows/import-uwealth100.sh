...
plink -pw "digima2018" digima@128.199.182.197 "~/export.sh"

## DATABASE ##
mysql -u$username -e "DROP DATABASE $database"
mysql -u$username -e "CREATE DATABASE $database"

curl --insecure "https://uwealth100.com/digimahouse_latest_backup.sql.gz" -o database/digimahouse_latest_backup.sql.gz
